...
if __name__ == '__main__':
	...
	# Load the timelines for the two users to observe the number of times their tweets have been favotited
	...
	avg_favorite2 = round(sum(favorited_count2) / tweets2, 2)
	avg_retweet1 = round(sum(retweet_count1) / tweets1, 2)
	avg_retweet2 = round(sum(retweet_count2) / tweets2, 2)
	favorite_per_user1 = round(sum(favorited_count1) / followers1, 2)
	...
	print("Favorited {} times ({} per tweet, {} per user)".format(sum(favorited_count1), avg_favorite1, favorite_per_user1))
	...
	print("Favorited {} times ({} per tweet, {} per user)".format(sum(favorited_count2), avg_favorite2, favorite_per_user2))
